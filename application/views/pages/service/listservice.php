                                 ...
                                 <tr>
                                    ...
                                    <td style="vertical-align: top;border-top: 1px solid #e3e6f0;text-align: center;" width="32%">
                                       ...
                                       <?php if ($data->status == "Menunggu Kedatangan") :  ?>
                                          ...
                                          <a href="#" data-toggle="modal" data-target="#modalupdatestatusservice" data-id="<?= $data->id_service; ?>" class="updatestatus btn btn-sm btn-secondary mr-1" title="Hapus" style="width: 150px;margin-bottom:5px" onclick="modalupdatestatus(this, 'service/updatestatusservice')" class="btn btn-sm btn-danger" role="button" title="Hapus"> <i class="fas fa-fw fa-pencil-alt"></i>Update Status </a>
                                       <?php endif ?>
                                       <?php if ($data->status == "Proses Perbaikan") :  ?>
                                          ...
                                          <a href="#" data-toggle="modal" data-target="#modalupdatestatusservice" data-id="<?= $data->id_service; ?>" class="updatestatus btn btn-sm btn-secondary mr-1" title="Hapus" onclick="modalupdatestatus(this, 'service/updatestatusservice')" class="btn btn-sm btn-danger" style="width: 150px;margin-bottom:5px" role="button" title="Hapus"> <i class="fas fa-fw fa-pencil-alt"></i>Update Status </a>
                                       <?php endif ?>
                                    </td>
                                 </tr>
                              <?php
