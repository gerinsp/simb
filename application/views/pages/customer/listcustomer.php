         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active"><a class="text-info" href="<?php echo base_url() ?>listcustomer">Customer</a></li>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
               ...
               <div class="shadow card">
                  <div class="card-body">
                     ...
                     <form action="<?php echo base_url() . 'customer/simpancustomer'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
                        <div class="row">
                           <div class="col-md-2">
                              <label for="">Nama Customer</label>
                           </div>
                           <div class="col-md-5">
                              <input class="form-control" required name="namacustomer" type="text">
                           </div>
                        </div>
                              ...
                              ?>
                                 <tr>
                                    ...
                                    <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="30%">
                                       <a href="#" data-toggle="modal" data-target="#modaleditCustomer" data-id="<?= $data->id_user; ?>" data-namacustomer="<?= $data->nama; ?>" data-username="<?= $data->username; ?>" onclick="modaleditCustomer(this, 'Customer/ubahcustomer')" class="editcustomer btn btn-sm btn-success" role="button" title="Ubah"><i class=" fas fa-fw fa-pencil-alt"></i> <?php echo $this->lang->line('change'); ?> </a>
                                       <a href="#" data-toggle="modal" data-target="#deleteModal" data-id="<?= $data->id_user; ?>" class="btn btn-sm btnOpenDeleteModal btn-danger mr-1" title="Hapus" onclick="openDeleteModal(this, 'Customer/hapuscustomer')" class="btn btn-sm btn-danger" role="button" title="Hapus"> <i class="fas fa-fw fa-trash"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                    </td>
                                 </tr>
                              <?php
                                 $no++;
...
<script>
   function modaleditCustomer(elem, link) {
      const id = $(elem).data("id");
      const namacustomer = $(elem).data("namacustomer");
      const username = $(elem).data("username");
      $("#idcustomer").attr("value", id);
      $("#namacustomer").attr("value", namacustomer);
      $("#usernamecustomer").attr("value", username);
      $("#formeditcustomer").attr("action", link);
   }
</script>
