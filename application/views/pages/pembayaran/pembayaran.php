            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">List Pembayaran</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="table-responsive">
                                <table style="border-collapse: 1;color: #858796;border-bottom: 2px solid #e3e6f0;" id="dataTable" class="table tablelist table-bordered table-striped" width="100%" height="1px" cellspacing="0">
                                    ...
                                    <tr height="20px">
                                        ...
                                        <th style=" padding: 0.75rem;vertical-align: top;border-top: 1px solid #e3e6f0;">Tanggal Lunas</th>
                                    ...
                                    foreach ($pembayaran as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="3%"><?php echo $data->nama_service ?></td>
                                            ...
                                            <td style="vertical-align: top;border-top: 1px solid #e3e6f0;" width="12%"><span class="badge badge-primary"><?= $data->status ?></span></td>
                                        </tr>
                                        <?php
                                        $no++;
                                    }
